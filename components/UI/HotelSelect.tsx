...
const HotelSelect = ({ hotel }) => {
  ...
  return (
    <Link href={"/rooms/" + hotel.id}>
      <motion.div
        className="bg-white/70 backdrop-blur-xl flex flex-col h-full items-center justify-center text-sm cursor-pointer group rounded-lg shadow-lg hover:shadow-xl transition ease-linear duration-200"
        initial={{
          opacity: 0,
        }}
        animate={{
